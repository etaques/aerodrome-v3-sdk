...
var FACTORY_ADDRESS = '0x5e7BB104d84c7CB9B682AaC2F3d509f5F406809A';
var ADDRESS_ZERO = '0x0000000000000000000000000000000000000000';
var POOL_INIT_CODE_HASH = '0xffb9af9ea6d9e39da47392ecc7055277b9915b8bfc9f83f105821b7791a6ae30';
/**
...
(function (FeeAmount) {
  ...
  FeeAmount[FeeAmount["LOWMEDIUM"] = 400] = "LOWMEDIUM";
...
function computePoolAddress(_ref) {
  ...
  var tickSpacing = getTickSpacing(fee);
  return getCreate2Address(factoryAddress, keccak256(['bytes'], [defaultAbiCoder.encode(['address', 'address', 'int24'], [token0.address, token1.address, tickSpacing])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.getTickSpacing = function getTickSpacing(fee) {
    if (fee === 100) return 1;
    if (fee === 400) return 8;
    if (fee === 500) return 10;
    if (fee === 2500) return 50;
